...
namespace BlackCoderMvcToDoApp.Controllers
{
    public class ToDoListController : Controller
    {
        private readonly BlackCoderMvcToDoAppContext _context;

        public ToDoListController(BlackCoderMvcToDoAppContext context)
        {
            _context = context;
        }
